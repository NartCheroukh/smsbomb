...
while 1:
    ...
    try:
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "amk 2 tane seçenek var zaten niye baska sey yazýyon. Tekrar dene.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Telefon numarasını başında '+90' olmadan yaz (Birden çoksa 'enter' tuşuna bası): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
        ...
        try:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "düzgün bir mail adresi gir . Tekrar dene.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + f"Kaç tane SMS göndermek istiyorsun {sonsuz}: "+ Fore.LIGHTGREEN_EX, end="")
            kere = input()
            if kere:
                kere = int(kere)
            else:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "düzgün gir. Tekrar dene.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
